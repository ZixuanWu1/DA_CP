# -*- coding: utf-8 -*-
"""LLM_abstracts_insert.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1H1kyrNlOnu0k5q0Zf8a_Rp9mgoFU3dxv
"""


import os
os.chdir('/home/zixuanwu/aug_llm')
...
with open("all_response_abstract_9000_new_low.pickle", "rb") as file:
    all_response = pickle.load(file)

with open("similarities_abstract_9000_new_low.pickle", "rb") as file:
    similarities = pickle.load(file)

with open("data_abstract_10000.pickle", "rb") as file:
...
with open(f'workspace_{orig_seed}.pkl', 'wb') as f:
