import pickle
with open("abstract_input_10000.pickle", "rb") as file:
   input_texts =  pickle.load( file)

with open("abstract_response_10000.pickle", "rb") as file:
...
with open("all_response_abstract_9000_new.pickle", "wb") as file:
...
with open("similarities_abstract_9000_new.pickle", "wb") as file:
